...
class Train
  ...
  def validate!
    ...
    raise ArgumentError, "Введён неверный формат номера!" if number !~ NUMBER_FORMAT
    raise ArgumentError, "Введён неверный тип поезда" unless [:passenger, :cargo].include? type
  end
end
